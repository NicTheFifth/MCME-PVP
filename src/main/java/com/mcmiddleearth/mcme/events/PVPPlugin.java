...
import com.mcmiddleearth.mcme.events.Handlers.*;
import com.mcmiddleearth.mcme.events.PVP.*;
...
public class PVPPlugin extends JavaPlugin{
    ...
    public void onEnable(){
        ...
        this.getCommand("t").setExecutor(new TeamChat());
        PluginManager pm = this.getServer().getPluginManager();
        pm.registerEvents(new ListenerCore(), this);
        pm.registerEvents(new MapEditor(), PVPPlugin.getPlugin());
        pm.registerEvents(new PlayerStat.StatListener(), PVPPlugin.getPlugin());
        pm.registerEvents(new Lobby.SignClickListener(), PVPPlugin.getPlugin());
        pm.registerEvents(new ChatHandler(), PVPPlugin.getPlugin());
        pm.registerEvents(new ServerMessageHandler(), PVPPlugin.getPlugin());
        pm.registerEvents(new JoinLeaveHandler(), PVPPlugin.getPlugin());
        pm.registerEvents(new AllGameHandlers(), PVPPlugin.getPlugin());
        pm.registerEvents(new PlayerStat.StatListener(), PVPPlugin.getPlugin());
        pm.registerEvents(new GearHandler.GearEvents(), PVPPlugin.getPlugin());
        pm.registerEvents(new AntiCheatListeners(), PVPPlugin.getPlugin());
        pm.registerEvents(new WeatherHandler(), PVPPlugin.getPlugin());
